...
/**
 * The persistence utility for the employer service. This utility wraps {@link EmployerPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class EmployerUtil {
	 ...
	 */
	public static Employer update(Employer employer, boolean merge)
		throws SystemException {
		return getPersistence().update(employer, merge);
	}
	...
	public static Employer update(Employer employer, boolean merge,
		...
		return getPersistence().update(employer, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.telefonica.model.Employer employer) {
	...
	*/
	public static com.telefonica.model.Employer create(int idEmployer) {
		return getPersistence().create(idEmployer);
	}
	...
	*/
	public static com.telefonica.model.Employer remove(int idEmployer)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.telefonica.NoSuchEmployerException {
		return getPersistence().remove(idEmployer);
	}

	public static com.telefonica.model.Employer updateImpl(
		com.telefonica.model.Employer employer, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(employer, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.telefonica.model.Employer findByPrimaryKey(int idEmployer)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.telefonica.NoSuchEmployerException {
		return getPersistence().findByPrimaryKey(idEmployer);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.telefonica.model.Employer fetchByPrimaryKey(
		int idEmployer)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(idEmployer);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.telefonica.model.Employer> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EmployerPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EmployerPersistence)PortletBeanLocatorUtil.locate(com.telefonica.service.ClpSerializer.getServletContextName(),
					EmployerPersistence.class.getName());

			ReferenceRegistry.registerReference(EmployerUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(EmployerPersistence persistence) {
	}

	private static EmployerPersistence _persistence;
}