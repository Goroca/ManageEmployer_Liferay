...
import com.telefonica.model.DepartmentClp;
import com.telefonica.model.EmployerClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"manageEmployer-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "manageEmployer-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.telefonica.model.impl.DepartmentImpl")) {
			return translateOutputDepartment(oldModel);
		}

		if (oldModelClassName.equals("com.telefonica.model.impl.EmployerImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.telefonica.NoSuchDepartmentException")) {
			return new com.telefonica.NoSuchDepartmentException();
		}

		if (className.equals("com.telefonica.NoSuchEmployerException")) {
			return new com.telefonica.NoSuchEmployerException();
		}
