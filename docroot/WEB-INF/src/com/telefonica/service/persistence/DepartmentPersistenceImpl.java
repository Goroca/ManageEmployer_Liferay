...
import com.telefonica.NoSuchDepartmentException;

import com.telefonica.model.Department;
import com.telefonica.model.impl.DepartmentImpl;
import com.telefonica.model.impl.DepartmentModelImpl;
...
public class DepartmentPersistenceImpl extends BasePersistenceImpl<Department>
	 ...
	 */
	public Department create(int idDept) {
		Department department = new DepartmentImpl();

		department.setNew(true);
		department.setPrimaryKey(idDept);
	 ...
	 */
	public Department remove(int idDept)
		throws NoSuchDepartmentException, SystemException {
		return remove(Integer.valueOf(idDept));
	}
	...
	@Override
	public Department updateImpl(com.telefonica.model.Department department,
	...
	protected Department toUnwrappedModel(Department department) {
		...
		departmentImpl.setIdDept(department.getIdDept());
		departmentImpl.setNameDept(department.getNameDept());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Department findByPrimaryKey(int idDept)
		throws NoSuchDepartmentException, SystemException {
		Department department = fetchByPrimaryKey(idDept);

		if (department == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + idDept);
			}
		...
		if (department == null) {
			...
			try {
				...
				if (department != null) {
					...
					EntityCacheUtil.putResult(DepartmentModelImpl.ENTITY_CACHE_ENABLED,
						DepartmentImpl.class, idDept, _nullDepartment);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.telefonica.model.Department")));
